...
ifneq ($(CROSS_BUILD_ENVIRON),y)
			{ sudo DEBIAN_FRONTEND=noninteractive dpkg -i --force-all $($*_DPKGFLAGS) $(DEBS_PATH)/$* $(LOG) && rm -d $(DEBS_PATH)/dpkg_lock && break; } || { set +e; rm -d $(DEBS_PATH)/dpkg_lock; sudo lsof /var/lib/dpkg/lock-frontend; ps aux; exit 1 ; }
else
