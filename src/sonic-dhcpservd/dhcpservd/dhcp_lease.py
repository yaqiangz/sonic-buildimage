...
class LeaseHanlder(object):
    def __init__(self, db_connector):
        ...
        self.lease_update_interval = DEFAULE_LEASE_UPDATE_INTERVAL
    ...
    def _update_lease(self, signum, frame):
        ...
        Args:
            ...
            signum: signal number, mandatory from signal.signal(), not used in this func
            frame: current stack frame, mandatory from signal.signal(), not used in this func
        """
