...
class KeaDhcp4LeaseHandler(LeaseHanlder):
    def __init__(self, db_connector, lease_file=KEA_LEASE_FILE_PATH, ip_ports_file=DHCP_SERVER_IP_PORTS_FILE):
        LeaseHanlder.__init__(self, db_connector)
        self.lease_file = lease_file
        self.ip_ports_file = ip_ports_file
    ...
    def _read(self):
        ...
        with open(self.ip_ports_file, "r", encoding="utf8")as fp:
