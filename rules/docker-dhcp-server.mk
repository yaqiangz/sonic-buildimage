...
$(DOCKER_DHCP_SERVER)_DEPENDS += $(ISC_DHCP_SERVER) $(SONIC_DHCPMON) $(SONIC_DHCPSERVER) $(LIBSWSSCOMMON) $(SONIC_RSYSLOG_PLUGIN) 

$(DOCKER_DHCP_SERVER)_DBG_DEPENDS = $($(DOCKER_CONFIG_ENGINE_BULLSEYE)_DBG_DEPENDS)
$(DOCKER_DHCP_SERVER)_DBG_DEPENDS += $(ISC_DHCP_SERVER_DBG) $(SONIC_DHCPSERVER_DBG) $(SONIC_DHCPMON_DBG) $(SONIC_RSYSLOG_PLUGIN)
...
$(DOCKER_DHCP_SERVER)_PACKAGE_DEPENDS = database^1.0.0

$(DOCKER_DHCP_SERVER)_SERVICE_REQUIRES = updategraph
$(DOCKER_DHCP_SERVER)_SERVICE_AFTER = swss syncd teamd
$(DOCKER_DHCP_SERVER)_SERVICE_BEFORE = ntp-config
$(DOCKER_DHCP_SERVER)_SERVICE_DEPENDENT_OF = swss
...
$(DOCKER_DHCP_SERVER)_CONTAINER_VOLUMES += /etc/timezone:/etc/timezone:ro
